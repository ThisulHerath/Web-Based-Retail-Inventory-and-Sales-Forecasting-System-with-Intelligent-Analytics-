...
const ViewPurchase = () => {
    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden print-area">
                {/* Invoice Header */}
                <div className="bg-gradient-to-r from-[#e6c700] to-primary-500 text-white p-8">
                        ...
                        <table className="w-full">
                            ...
                            <tfoot className="bg-gray-50">
                                <tr>
                                    ...
                                    <td className="py-4 px-4 text-right font-bold text-xl text-[#04994ef9]">LKR {purchase.totalAmount.toLocaleString('en-LK', { minimumFractionDigits: 2 })}</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
