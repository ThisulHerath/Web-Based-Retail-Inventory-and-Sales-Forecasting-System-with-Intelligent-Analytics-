...
const StockOut = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (product && Number(quantity) > displayedStock) {
            setToast({ type: 'error', message: 'Cannot remove more than displayed stock' });
            return;
        }
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            required
                            min="1"
                            max={product.displayedStock ?? product.currentStock ?? 0}
                            ...
                            autoFocus
                        />
                        <p className="text-xs text-gray-500 mt-1">Max available (Displayed): {product.displayedStock ?? product.currentStock ?? 0}</p>
                    </div>
