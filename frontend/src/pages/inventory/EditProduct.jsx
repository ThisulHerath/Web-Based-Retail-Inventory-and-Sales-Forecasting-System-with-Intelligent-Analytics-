...
const EditProduct = () => {
    ...
    const handleImageChange = (e) => {
        ...
        if (file) {
            ...
            setFormData(prev => ({ ...prev, productImage: file, removeImage: false }));
            // Create preview
    ...
    const removeImage = () => {
        setFormData(prev => ({ ...prev, productImage: null, existingImage: null, removeImage: true }));
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (formData.productImage) {
                ...
                submitData.append('removeImage', String(formData.removeImage));
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex gap-2">
                                                <label className="text-sm text-[#f5d800] hover:text-[#155c27] font-medium cursor-pointer">
                                                    <input
                                                        type="file"
                                                        className="hidden"
                    ...
                    <div className="flex justify-end pt-4 gap-3">
                        ...
                        <button type="submit" disabled={saving}
                            className={`flex items-center gap-2 px-6 py-2 bg-[#f5d800] text-[#155c27] font-weight-600 rounded-lg hover:bg-[#e6c700] transition-colors ${saving ? 'opacity-70 cursor-not-allowed' : ''}`}>
