        ...
        return (
            <div className="text-center py-12">
                ...
                <button
                    ...
                    className="mt-4 px-4 py-2 bg-[#f5d800] text-[#155c27] font-weight-600 rounded-lg hover:bg-[#e6c700]"
                >
                    Back to Sales
                </button>
            </div>
            ...
            <div className="flex items-center justify-between no-print">
                ...
                <div className="flex gap-3">
                    <Link
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-[#f5d800] text-[#5c1515] font-weight-600 rounded-lg hover:bg-[#e6c700] transition-colors"
                    >
            ...
            <div className="bg-white rounded-xl shadow-md p-8 border border-gray-100 print-area">
                ...
                <div className="border-b-2 border-gray-300 pb-6 mb-6">
                    <div className="flex justify-between items-start">
                        <div>
                            <h1 className="text-4xl font-bold text-[#03a132] mb-2">
                                7 Super City
                            </h1>
                ...
                <div className="mb-6">
                    ...
                    {sale.couponUsed && (
                        <p className="text-gray-600">
                            Coupon Applied: <span className="font-medium text-green-700">Yes</span>
                        </p>
                    )}
                </div>
                ...
                <div className="flex justify-end">
                    <div className="w-64">
                            ...
                            <>
                                <div className="flex justify-between py-2 border-b border-gray-200">
                                    ...
                                    <span className="font-semibold text-green-700">
                                        - LKR {sale.discountAmount.toFixed(2)}
                                    </span>
                                </div>
                                <div className="flex justify-between py-2 border-b border-gray-200">
                                    <span className="text-gray-700">Discounted Subtotal:</span>
                                    <span className="font-semibold text-gray-800">
                                        LKR {(sale.discountedSubtotal || (sale.subtotal - sale.discountAmount)).toFixed(2)}
                                    </span>
                                </div>
                            </>
                        )}
                        ...
                        <div className="flex justify-between py-3 border-t-2 border-gray-300 mt-2">
                            ...
                            <span className="text-xl font-bold text-[#03a132]">
