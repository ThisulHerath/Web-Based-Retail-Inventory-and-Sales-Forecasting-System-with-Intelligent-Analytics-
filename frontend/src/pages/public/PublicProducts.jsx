...
const PublicProducts = () => {
    ...
    return (
        <div className="w-full bg-[var(--color-bg-primary)]">
            <section className="relative h-[40vh] min-h-[320px] bg-gradient-to-r from-[#155c27] via-[#1a6e30] to-transparent overflow-hidden">
                <div
                ...
                <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
                    <div className="max-w-2xl text-white">
                        <span className="text-[#f5d800] font-bold tracking-widest uppercase text-xs">Shop</span>
                    ...
                    {products.map((product) => (
                        <div key={product._id} className="group bg-[var(--color-card-bg)] rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-[var(--color-border)] flex flex-col">
                            ...
                            <div className="p-5 flex flex-col flex-1">
                                <p className="text-[10px] text-[#f5d800] font-bold uppercase tracking-widest mb-1">
                                    {product.category?.categoryName || 'General'}
                                </p>
                                <h3 className="font-bold text-[var(--color-text-primary)] text-base mb-2 truncate group-hover:text-[#f5d800] transition-colors">
                                    {product.productName}
                                </h3>
                                {product.description && (
            ...
            <div className="mt-16 bg-[var(--color-bg-secondary)] rounded-2xl p-8 text-center border border-[var(--color-border)]">
                <ShoppingBag className="w-12 h-12 text-[#f5d800] mx-auto mb-4" />
                ...
                <a
                    ...
                    className="inline-block mt-4 bg-[#f5d800] text-[#155c27] font-weight-600 px-6 py-3 rounded-full font-semibold hover:bg-[#e6c700] transition-colors"
                >
                    Get Directions
                </a>
            </div>
