            ...
            <section className="relative h-[85vh] bg-gray-900 dark:bg-gray-950 flex items-center overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-xl animate-fade-in-up">
                        <span className="text-[#f5d800] font-bold tracking-widest uppercase text-sm mb-4 block animate-slide-in-left">Premium Retail Experience</span>
                        <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight mb-6 tracking-tight animate-fade-in-up stagger-1">
                            Premium Quality <span className="text-[#f5d800]">Products</span> at 7 Super City
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 underline-offset-4 animate-fade-in-up stagger-3">
                            <Link
                                to="/products"
                                className="bg-[#f5d800] text-[#155c27] font-weight-600 px-8 py-4 rounded-full font-bold text-lg flex items-center justify-center gap-2 hover:bg-[#e6c700] transition-all hover:scale-105 shadow-xl shadow-[rgba(245,216,0,0.2)] hover:shadow-2xl hover:shadow-[rgba(245,216,0,0.3)]"
                            >
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div className="flex items-center gap-4 p-4 rounded-xl hover:bg-[var(--color-bg-secondary)] transition-all duration-300 animate-fade-in-up hover:scale-105">
                            <div className="bg-[#d4e8d0] dark:bg-[#0d3d1a]/30 p-3 rounded-lg"><Truck className="w-6 h-6 text-[#f5d800]" /></div>
                        ...
                        <div className="flex items-center gap-4 p-4 rounded-xl hover:bg-[var(--color-bg-secondary)] transition-all duration-300 animate-fade-in-up stagger-1 hover:scale-105">
                            <div className="bg-[#d4e8d0] dark:bg-[#0d3d1a]/30 p-3 rounded-lg"><ShieldCheck className="w-6 h-6 text-[#f5d800]" /></div>
                        ...
                        <div className="flex items-center gap-4 p-4 rounded-xl hover:bg-[var(--color-bg-secondary)] transition-all duration-300 animate-fade-in-up stagger-2 hover:scale-105">
                            <div className="bg-[#d4e8d0] dark:bg-[#0d3d1a]/30 p-3 rounded-lg"><Clock className="w-6 h-6 text-[#f5d800]" /></div>
                        ...
                        <div className="flex items-center gap-4 p-4 rounded-xl hover:bg-[var(--color-bg-secondary)] transition-all duration-300 animate-fade-in-up stagger-3 hover:scale-105">
                            <div className="bg-[#d4e8d0] dark:bg-[#0d3d1a]/30 p-3 rounded-lg"><Star className="w-6 h-6 text-[#f5d800]" /></div>
            ...
            <section className="relative overflow-hidden bg-[var(--color-bg-primary)]">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex justify-between items-end mb-12 animate-fade-in-up">
                            <div>
                                ...
                                <p className="mt-2 text-lg font-light italic text-[#f5d800] dark:text-[#f5d800]">Freshly stock items in our shelves</p>
                            </div>
                            <Link to="/products" className="text-[#f5d800] dark:text-[#f5d800] font-bold hover:underline flex items-center gap-2 hover:scale-105 transition-transform">
                                    ...
                                    <div className="aspect-square bg-[var(--color-bg-secondary)] relative overflow-hidden flex items-center justify-center">
                                        ...
                                        <div className="absolute top-4 left-4">
                                            {product.isActive === false ? (
                                                ...
                                                <span className="bg-white/90 dark:bg-gray-800/90 backdrop-blur px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider text-[#f5d800] shadow-lg">New</span>
                                            )}
                                        </div>
                                    </div>
                                    <div className="p-6">
                ...
                <div className="relative py-28">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
                        <div className="text-[var(--color-text-primary)] animate-fade-in-up">
                            <span className="text-[#f5d800] dark:text-[#f5d800] font-bold tracking-widest uppercase text-xs">Experience</span>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="group relative h-72 rounded-2xl overflow-hidden bg-gradient-to-br from-[#1e7a34] to-[#155c27] cursor-pointer hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-[#1e7a34]/30 animate-fade-in-up">
                            <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-8 text-center">
                                ...
                                <p className="text-green-100 text-sm">Check out the latest additions to our shelves</p>
                            </div>
                        </div>
                        <div className="group relative h-72 rounded-2xl overflow-hidden bg-gradient-to-br from-[#f5d800] to-[#e6c700] cursor-pointer hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-[#f5d800]/30 animate-fade-in-up stagger-1">
                            <div className="absolute inset-0 flex flex-col items-center justify-center text-[#155c27] p-8 text-center">
                                ...
                                <p className="text-[#155c27]/80 text-sm">Most popular products chosen by our customers</p>
                            </div>
                        </div>
                        <div className="group relative h-72 rounded-2xl overflow-hidden bg-gradient-to-br from-[#0d3d1a] to-[#0a2811] cursor-pointer hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-[#0d3d1a]/30 animate-fade-in-up stagger-2">
                            <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-8 text-center">
                                ...
                                <p className="text-green-100 text-sm">Special deals and promotions this season</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        {[
                            ...
                            <div key={i} className={`bg-[var(--color-card-bg)] p-10 rounded-3xl relative shadow-sm hover:shadow-xl transition-all duration-300 border border-[var(--color-border)] hover:scale-105 animate-fade-in-up stagger-${i}`}>
                                <span className="absolute top-6 right-8 text-6xl text-[#f5d800] dark:text-[#155c27] font-serif">"</span>
                                <div className="flex gap-1 mb-6">
                                    {[...Array(rev.stars)].map((_, j) => <Star key={j} className="w-4 h-4 fill-primary-500 text-[#f5d800]" />)}
                                </div>
                                <p className="text-[var(--color-text-secondary)] leading-relaxed italic mb-8">"{rev.text}"</p>
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-full bg-[#f5d800] text-[#155c27] font-weight-600 flex items-center justify-center font-bold text-xl">{rev.name[0]}</div>
